/* ========================================
   WHATSAPP BUTTON - ULTRA PREMIUM
   Bouton flottant WhatsApp avec animation
   ======================================== */
...
const WhatsAppButton = () => {
  ...
  const handleClick = () => {
    const phoneNumber = CONTACT.phones.secondary.replace(/\s/g, '');
    const message = encodeURIComponent('Bonjour, je souhaite obtenir des informations sur vos services de rénovation énergétique.');
